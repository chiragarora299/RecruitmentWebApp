...
if($con->connect_error){
    ...
    if($stmt_result->num_rows > 0){
        ...
        if($data['Pass'] === $Pass){
            ...
            //echo"<h2>indalid password</h2>";
          exit('Invalid passowrd')  ;
        }
    }else{
        //echo "<h2>invalid</h2>";
...
<html lang="en">
    ...
    <title>CRM RECRUITMENT SYSTEM</title>
...
<body>
    ...
    <img src ="user.png" align="left" class= "w3-center">
</div>
<div class="w3-center w3-container w3-xlarge"> 
    <b>EXCELLENCE THROUGH FINDING PEOPLE</b>
</div>
</body>
</html>
